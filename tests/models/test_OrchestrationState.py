...
def test_empty_state_to_json_string():
    ...
    state = OrchestratorState(is_done=False, actions=actions, output=None, error=None, custom_status=None)
...
def test_single_action_state_to_json_string():
    actions: List[List[IAction]] = []
    action: IAction = CallActivityAction(function_name="MyFunction", input_="AwesomeInput")
